Public Class Constant
    Inherits Form3
    Public Const CURRENT_MODE As String = "DEV" ' DEV / LIVE / DEBUG
    ...
    Public Const COMPANY_CODE As String = "Comp0001" ' Company Code as shown in BUSY
    Public Const COMPANY_CODE_ALTER As String = "Comp0002" ' Company Code as shown in BUSY
